...
class Ggs_Helper {
	...
	public static function radiobox( $args = array() ){
		...
		<div class="form-group form-group-radiobox">
			...
			<input id="<?php echo $settings['id'] ?>_true" name="ggsupports_options[<?php echo $settings['id'] ?>]" type="radio" value="<?php echo $settings['value']['true'] ?>" <?php Ggs_Helper::checked( $settings['id'], 1, $settings['default'] ) ?> />
			<label for="<?php echo $settings['id'] ?>_true" >
				<?php echo $settings['label']['true'] ?>
			</label>
			<input id="<?php echo $settings['id'] ?>_false" name="ggsupports_options[<?php echo $settings['id'] ?>]" type="radio" value="<?php echo $settings['value']['false'] ?>" <?php Ggs_Helper::checked( $settings['id'], 0, $settings['default'] ) ?> />
