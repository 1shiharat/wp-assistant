...
class source extends field {
	...
	public function render() {
		...
		?>
		<textarea class="wpa-url aceeditor" style="width: <?php echo $this->options['width']; ?>; height: <?php echo $this->options['height']; ?>;" data-lang="css" name="<?php echo $this->get( 'id' ); ?>" id="<?php echo $this->get( 'id' ); ?>" cols="30" rows="10" style="width: 100%"><?php echo stripslashes_deep( $this->value ) ?></textarea>
